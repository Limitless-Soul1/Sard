...
export const ar: Record<TKey, string> = {
  ...
  "pdf.appearance.hint": "المعكوس وضعٌ ليليٌّ تقريبيّ (يقلب الألوان والصور) — وليس سمات القراءة.",
...
"gs.bookmark.subtitle": "كيف يبدو موضعك المحفوظ على الصفحة. اختر شكلًا ثم لونًا.",
  ...
  // الترجمة (من التحديد؛ جوجل غير الرسمي + DeepL الرسمي)
  "tr.act": "ترجمة",
  ...
  "tr.provider": "المزوّد",
  "tr.provider.google": "جوجل",
  "tr.provider.deepl": "DeepL",
  "tr.provider.googleHint": "مجاني دون حساب. نقطة وصول غير موثّقة وقد تتوقّف.",
  "tr.provider.deeplHint": "أفضل جودة. يتطلب مفتاح API مجاني من deepl.com.",
  "tr.key": "مفتاح DeepL",
  "tr.key.placeholder": "الصق مفتاح DeepL هنا",
  "tr.key.replace": "أدخل مفتاحًا جديدًا لاستبدال المحفوظ",
  "tr.key.set": "تم حفظ مفتاح",
  "tr.key.save": "حفظ المفتاح",
  "tr.key.clear": "مسح",
  "tr.key.hint": "يُحفظ محليًّا في قاعدة بيانات سَرد ولا يُرسَل إلى الواجهة أبدًا.",
  "tr.target": "لغة الوجهة",
