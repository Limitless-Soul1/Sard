...
"gs.bookmark.subtitle": "How your saved place looks on the page. Pick a shape, then a colour.",
  ...
  // ---- READING DEPOSITS ----
  // A deposit: one book, one reader's marks on it, and a letter.
  "dep.chapters": "{n} chapters",
  "dep.closeSheet": "Close the deposit",
  ...
  "dep.recv.eyebrow": "A reading deposit reached you",
  "dep.recv.haveBook": "{name} shared this book with you — and you already have it",
  "dep.recv.bringsBook": "{name} shared this book with you, and it travels with the deposit",
  ...
  "dep.recv.already": "This deposit reached you before — nothing was added again.",
  ...
  "dep.menu": "Give this reading",
  "dep.eyebrow": "Reading deposit",
  ...
  "dep.letterNote": "travels with the deposit",
  "dep.letterPlaceholder": "Write to whoever you are giving this reading…",
  "dep.signNote": "your signature on the deposit",
  ...
  "dep.mapLoose": "{n} with no place",
  "dep.mapWhole": "{n} across the whole book",
  "dep.sheafLabel": "The deposit's layers",
  "dep.open": "Open",
  "dep.close": "Close",
  ...
  "dep.readLabel": "Read the deposit",
  "dep.readEyebrow": "As it will arrive",
  "dep.readFoot": "Reading sends nothing",
  "dep.readEmpty": "The deposit is empty — you have kept nothing in it.",
  "dep.sumLabel": "In the deposit",
  ...
  "dep.cta": "Give the reading deposit",
  "dep.cancel": "Cancel",
  "dep.doneTitle": "The deposit is bound",
  ...
  "dep.err.notEpub": "Deposits are for EPUB books for now.",
  "dep.err.unreadable": "This deposit could not be read — the file is not legible.",
  "dep.err.notSard": "This file is not a reading deposit.",
  "dep.err.newer": "This deposit comes from a newer Sard than yours.",
  "dep.err.badBook": "The book identity in this deposit is not valid.",
  "dep.err.noMember": "A file is missing inside the deposit.",
  "dep.err.bookMismatch": "The book inside the deposit does not match its identity.",
  "dep.err.bookUnreadable": "The book attached to this deposit could not be read.",
  "dep.err.tooLarge": "The deposit is larger than can be written.",
  "dep.err.badMember": "A path inside the deposit is not allowed.",
  "dep.err.bookTooLarge": "The book file is larger than the limit.",
  "dep.err.write": "The deposit could not be written.",
