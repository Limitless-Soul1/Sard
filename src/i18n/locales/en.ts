...
"gs.bookmark.subtitle": "How your saved place looks on the page. Pick a shape, then a colour.",
  ...
  // Translation (selection-based; Google unofficial + DeepL official)
  "tr.act": "Translate",
  ...
  "tr.provider.googleHint": "Free, no account needed. Undocumented endpoint — may stop working.",
  "tr.provider.deeplHint": "Best quality. Needs a free-tier API key from deepl.com.",
  "tr.key": "DeepL API key",
  "tr.key.placeholder": "Paste your DeepL key",
  "tr.key.replace": "Enter a new key to replace the saved one",
  "tr.key.set": "A key is saved",
  "tr.key.save": "Save key",
  "tr.key.clear": "Clear",
  "tr.key.hint": "Stored locally in Sard's database; never sent to the interface.",
