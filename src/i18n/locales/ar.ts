...
"gs.bookmark.subtitle": "كيف يبدو موضعك المحفوظ على الصفحة. اختر شكلًا ثم لونًا.",
  ...
  // ---- MOBILE SHELL ------------------------------------------------------------------------------
  // Strings the mobile chrome needs, taken verbatim from the mobile shell.
  "lib.shelf.create": "إنشاء",
  "lib.empty.noMatchSub": "جرّب ترتيبًا أو تصفيةً أو لغةً مختلفة.",
  "lib.sortFilter": "الترتيب والتصفية",
  "lib.reset": "إعادة ضبط",
  "lib.show": "إظهار",
  "lib.show.reading": "قيد القراءة",
  "lib.show.unread": "لم تُقرأ",
  "lib.show.withNotes": "بها ملاحظات",
  "lib.language.any": "أي لغة",
  "lib.showBooks": "إظهار {n} كتابًا",
  "lib.emptyMobile.sub":
    "تظهر هنا الكتب التي تضيفها. يقرأ «سَرْد» صيغتَي EPUB وPDF، وتُستخرج الأغلفة والبيانات تلقائيًّا.",
  "m.search.books": "الكتب · {n}",
  "m.search.notes": "في ملاحظاتك · {n}",
  "m.search.shelves": "الأرفف · {n}",
  "m.search.shelfCount": "{n} كتابًا",
  "m.book.chapters": "{n} فصلًا",
  "m.book.addToShelf": "أضف إلى رفّ",
  "m.book.remove": "أزل من المكتبة",
  "m.book.removeConfirm": "إزالة هذا الكتاب وكل تظليلاته وملاحظاته وإشاراته؟ لا يمكن التراجع.",
  "m.book.lastRead": "{p}٪ · آخر قراءة {when}",
  "m.book.notStarted": "لم تبدأ",
  "m.book.added": "أُضيف {when}",
  "m.continue": "متابعة القراءة",
  "m.recent": "قرأتها مؤخّرًا",
  "m.allBooks": "كل الكتب",
  "m.notStarted": "لم تُقرأ بعد",
  "m.finished": "انتهت",
  "m.theme": "السمة",
  "m.now": "الآن",
  "m.read": "مقروء",
  "m.noBookmarks": "لا إشارات مرجعية في هذا الكتاب بعد",
  "m.noMarks": "لا علامات بعد",
  "m.tight": "ضيّق",
  "m.normal": "عادي",
  "m.airy": "واسع",
  "m.narrow": "ضيّقة",
  "m.comfortable": "مريحة",
  "m.wide": "واسعة",
  "m.themesLight": "سمات فاتحة · للنهار",
  "m.themesDark": "سمات داكنة · لليل",
  "sel.title": "المقطع المحدَّد",
  "sel.ink": "لون التظليل",
  "sel.note": "ملاحظة",
  "sel.copy": "نسخ",
  "sel.reference": "مرجع",
  "sel.card": "بطاقة",
  "sel.copied": "نُسخ المقطع",
  "ref.scopeHint": "يسري على الكتاب كلّه",
