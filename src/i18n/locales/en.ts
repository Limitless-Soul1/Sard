...
"gs.bookmark.subtitle": "How your saved place looks on the page. Pick a shape, then a colour.",
  ...
  "lib.shelf.create": "Create",
  "lib.empty.noMatchSub": "Try a different sort, filter, or language.",
  "lib.sortFilter": "Sort & filter",
  "lib.reset": "Reset",
  "lib.show": "Show",
  "lib.show.reading": "Reading",
  "lib.show.unread": "Unread",
  "lib.show.withNotes": "With notes",
  "lib.language.any": "Any",
  "lib.showBooks": "Show {n} books",
  "lib.emptyMobile.sub":
    "Books you add appear here. Sard reads EPUB and PDF — covers and metadata fill in automatically.",
  "m.search.books": "Books · {n}",
  "m.search.notes": "In your notes · {n}",
  "m.search.shelves": "Shelves · {n}",
  "m.search.shelfCount": "{n} books",
  "m.book.chapters": "{n} chapters",
  "m.book.addToShelf": "Add to shelf",
  "m.book.remove": "Remove from library",
  "m.book.removeConfirm": "Remove this book and all its highlights, notes and bookmarks? This can’t be undone.",
  "m.book.lastRead": "{p}% · last read {when}",
  "m.book.notStarted": "Not started",
  "m.book.added": "added {when}",
  "m.continue": "Continue",
  "m.recent": "Recent",
  "m.allBooks": "All books",
  "m.notStarted": "Not started",
  "m.finished": "Finished",
  "m.theme": "Theme",
  "m.now": "now",
  "m.read": "Read",
  "m.noBookmarks": "No bookmarks in this book yet",
  "m.noMarks": "Nothing marked yet",
  "m.tight": "Tight",
  "m.normal": "Normal",
  "m.airy": "Airy",
  "m.narrow": "Narrow",
  "m.comfortable": "Comfortable",
  "m.wide": "Wide",
  "m.themesLight": "Light themes · used by day",
  "m.themesDark": "Dark themes · used at night",
  "sel.title": "Selected passage",
  "sel.ink": "Highlight colour",
  "sel.note": "Note",
  "sel.copy": "Copy",
  "sel.reference": "Reference",
  "sel.card": "Card",
  "sel.copied": "Passage copied",
  "ref.scopeHint": "Applies to the whole book",
