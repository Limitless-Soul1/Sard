...
export const ar: Record<TKey, string> = {
  ...
  // RAWY-86: PDF المرحلة 1 — التنقّل والبحث والنسخ والعكس.
  ...
  "pdf.find": "بحث في PDF",
  "pdf.find.placeholder": "ابحث عن نص…",
  "pdf.find.action": "بحث",
  "pdf.find.searching": "جارٍ البحث…",
  "pdf.find.found": "وُجد في الصفحة {n}",
  "pdf.find.none": "لا نتيجة",
  "pdf.find.hint": "يبحث في طبقة النصّ داخل ملفّ PDF نفسه. بعض الملفّات — وخاصّةً العربيّة — تخزّن نصّها بصورة مشوّشة يتعذّر على البحث قراءتها.",
