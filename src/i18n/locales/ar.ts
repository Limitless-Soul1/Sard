...
"gs.bookmark.subtitle": "كيف يبدو موضعك المحفوظ على الصفحة. اختر شكلًا ثم لونًا.",
  ...
  // البوّابة نفسها حين لا يكون المحرّك WebView2 — محرّك ويب النظام في أندرويد أو محرّك WebKit.
  // لا يستطيع «سَرْد» تثبيت محرّك هناك، ولا يستطيع القارئ ذلك أيضًا: في أندرويد يحدّثه المتجر وفق
  // جدوله، وفي أنظمة آبل يتبع نظام التشغيل. لذلك يذكر هذا النصّ الحال ويقف، بدل عرض تنزيل لا يفيد.
  "err.gate.title.engine": "يحتاج «سَرْد» إلى محرّك ويب أحدث",
  "err.gate.body.engine":
    "يقرأ «سَرْد» الكتب عبر محرّك الويب المدمج في هذا الجهاز. والإصدار المثبَّت عليه أقدم من أن يفتح الكتب بأنواعها.",
  "err.gate.how.engine":
    "يرتفع هذا الإصدار بتحديث محرّك ويب النظام أو بتحديث نظام تشغيل الجهاز. ولا يستطيع «سَرْد» تثبيته نيابةً عنك.",
