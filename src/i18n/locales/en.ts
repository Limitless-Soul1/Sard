...
export const en = {
  ...
  "gs.uiFont": "INTERFACE FONT",
  "gs.uiFontHint": "menus, lists & chrome — not book text",
  ...
  "gs.defaultLatin": "DEFAULT BOOK FONT · LATIN",
  "gs.defaultArabic": "DEFAULT BOOK FONT · ARABIC",
